...
<div class="container">
    <div class="category-list">
        <?php
        $categorii = [
            'sport' => ['nume' => 'Încălțăminte Sport'],
            'casual' => ['nume' => 'Încălțăminte Casual'],
            'eleganta' => ['nume' => 'Încălțăminte Elegantă'],
            'sandale' => ['nume' => 'Sandale']
        ];
...
<script>
    window.currentCategory = 'incaltaminte';
</script>
</body>
</html>